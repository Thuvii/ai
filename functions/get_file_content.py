    ...
    parameters=types.Schema(
        ...
        properties={
            "directory": types.Schema(
                ...
                description="The directory to read file content from, relative to the working directory. If not provided, return file content in the working directory itself.",
            ),
